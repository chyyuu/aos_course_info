...
Edsger W. Dijkstra ,Technological University, Eindhoven, The Netherlands, SOSP, 1968 
 ...
 - [Multiprogramming a 64 kB Computer Safely and Efficiently](https://dl.acm.org/authorize?N47259),Amit Levy and Bradford Campbell and Branden Ghena and Daniel Giffin and Pat Pannuto and Prabal Dutta and Philip Levis. SOSP 2017
     - the embedded OS in RUST language
...
### Memory Management
 ...
 - [Machine-Independent Virtual Memory Management for Paged Uniprocessor and Multiprocessor Architectures](http://portal.acm.org/citation.cfm?id=36206.36181), Richard Rashid, Avadis Tevanian, Michael Young, David Golub, Robert Baron, David Black, William Bolosky, and Jonathan Chew, ASPLOS 1987.  
     - **SIGOPS: The Hall of Fame Award**   
...
### Concurrency/Sync&Mutex
 ...
 - [On optimistic methods for concurrency control](http://doi.acm.org/10.1145/319566.319567), H. T. Kung(孔祥重) and John T. Robinson., ACM Transactions on Database Systems (TODS) 6(2), June 1981, 213-226. 
...
### Distributed Systems
 ...
 - [Managing update conflicts in Bayou, a weakly connected replicated storage system](http://doi.acm.org/10.1145/224057.224070),D. B. Terry, M. M. Theimer, Karin Petersen, A. J. Demers, M. J. Spreitzer, and C. H. Hauser., SOSP 1995. 
 ...
 - [Chord: A scalable peer-to-peer lookup service for Internet applications](http://doi.acm.org/10.1145/383059.383071), Ion Stoica, Robert Morris, David Karger, M. Frans Kaashoek, and Hari Balakrishnan., SIGCOMM 2001.
...
Jeffrey Dean and Sanjay Ghemawat, OSDI 2004.
 ...
 - [Bigtable: A Distributed Storage System for Structured Data](http://dl.acm.org/citation.cfm?id=1267323), Fay Chang, Jeffrey Dean, Sanjay Ghemawat, Wilson C. Hsieh, Deborah A. Wallach, Mike Burrows, Tushar Chandra, Andrew Fikes, and Robert E. Gruber., OSDI 2006.
    - **SIGOPS: The Hall of Fame Award**  
 - [Dynamo: Amazon’s Highly Available Key-value Store](https://doi.org/10.1145/1294261.1294281), Giuseppe DeCandia, Deniz Hastorun, Madan Jampani, Gunavardhan Kakulapati, Avinash Lakshman, Alex Pilchin, Swaminathan Sivasubramanian, Peter Vosshall, and Werner Vogels., SOSP 2007.
 ...
 - [The Chubby lock service for loosely-coupled distributed systems](https://dl.acm.org/citation.cfm?id=1298487),Mike Burrows., OSDI 2006. 
...
### Virtual Machine Monitor
 - [A virtual machine time-sharing system](http://dx.doi.org/10.1147/sj.93.0199),R. A. Meyer and L. H. Seawright. IBM Systems Journal 9(3), September 1970, 199-218. 
 ...
 - [Memory Resource Management in VMware ESX Server](http://dl.acm.org/citation.cfm?id=844146), Carl A. Waldspurger. , OSDI 2002. 
...
### Network
 ...
 - [The Click Modular Router](http://dl.acm.org/citation.cfm?id=354874), Eddie Kohler, Robert Morris, Benjie Chen, John Jannotti and Frans Kaashoek. ACM Transactions on Computer Systems (TOCS), 18(3), August 2000.
...
### File System
 ...
 - [A Fast File System for UNIX](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.114.9535&rank=1&q=A%20Fast%20File%20System%20for%20UNIX&osm=&ossid=),Marshall K. McKusick, William N. Joy, Samuel J. Leffler, and Robert S. Fabry, ACM Transactions on Computer Systems (TOCS) 2(3), August 1984, 181-197. 
 ...
 - [Disconnected operation in the Coda File System](http://doi.acm.org/10.1145/146941.146942),James J. Kistler and M. Satyanarayanan., ACM Transactions on Computer Systems (TOCS) 10(1), February 1992, 3-25.
 ...
 - [The Google File System](http://research.google.com/archive/gfs-sosp2003.pdf),Sanjay Ghemawat, Howard Gobioff, and Shun-Tak Leung.,SOSP 2003
...
### Bugs/Security/Fault-Tolerant/Recovery
 ...
 - [Efficient software-based fault isolation](http://doi.acm.org/10.1145/168619.168635), Robert Wahbe, Steven Lucco, Thomas E. Anderson, and Susan L. Graham., SOSP 1993.
 ...
 - [ReVirt: Enabling intrusion analysis through virtual-machine logging and replay](http://doi.acm.org/10.1145/844128.844148), George W. Dunlap, Samuel T. King, Sukru Cinar, Murtaza A. Basrai, and Peter M. Chen., OSDI 2002.
